...
extern "C"
JNIEXPORT jint JNICALL
Java_com_example_caucse_alonehealth_SeveralExercise_CountWhitePixelsInOneRow(JNIEnv *env,
                                                                             jobject instance,
                                                                             jlong matAddrInput,
                                                                             jint indexOfStart,
                                                                             jint indexOfEnd) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_caucse_alonehealth_SeveralExercise_CreateDifferenceImage(JNIEnv *env,
                                                                          jobject instance,
                                                                          jlong matAddrSource,
                                                                          jlong matAddrTarget,
                                                                          jlong matAddrResult) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_example_caucse_alonehealth_SeveralExercise_CountWhitePixels(JNIEnv *env,
                                                                     jobject instance,
                                                                     jlong matAddrInput) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_caucse_alonehealth_SeveralExercise_ConvertRGBtoGray(JNIEnv *env, jobject instance,
                                                                     jlong matAddrInput,
                                                                     jlong matAddrResult) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_caucse_alonehealth_SeveralExercise_InvertMat(JNIEnv *env, jobject instance,
                                                              jlong matAddrInput,
                                                              jlong matAddrResult) {
